...
import br.edu.fateccotia.projectsmartrow.exceptions.ExcessaoHttp;
import br.edu.fateccotia.projectsmartrow.model.Endereco;
import br.edu.fateccotia.projectsmartrow.util.ConversorJsonString;
...
public class BuscaCepAPI {
	...
	public static Endereco buscaCep(String cep) {
		...
		try {
			...
			throw new ExcessaoHttp(e.getMessage());
		}
	}
